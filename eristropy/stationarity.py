...
from eristropy._difference import _difference_all_signals
from eristropy._gp import _detrend_all_signals_gp_numba, _detrend_all_signals_gp_sklearn
from eristropy._linreg import _detrend_all_signals_linreg
